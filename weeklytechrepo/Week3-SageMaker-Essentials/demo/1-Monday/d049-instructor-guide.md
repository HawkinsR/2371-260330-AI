...
**Time:** 20 mins
1. Open `code/d049-sagemaker-script-mode-setup.py`.
...
## Summary
Reiterate that Script Mode allows Data Scientists to write native PyTorch code and leverage massive cloud compute without needing to become DevOps engineers.
