...
def register_new_model(registry):
    ...
    # 1. TODO: Call registry.create_model_package()
    # Group Name: "CustomerChurnPredictors"
    # Metrics: {"ModelQuality": {"S3Uri": "s3://eval-bucket/accuracy.json"}}
    # Status: "PendingManualApproval"
    # Spec: {"Containers": [{"ModelDataUrl": "s3://artifact-bucket/model.tar.gz"}], "SupportedContentTypes": ["application/json"]}
    package_arn = None
...
def approve_model(registry, package_arn):
    ...
    # 2. TODO: Call registry.update_model_package()
    # Pass the package_arn and update the status to "Approved"
...
if __name__ == "__main__":
    ...
    # TODO: Instantiate a MockSageMakerPipeline named "Enterprise-Auto-ML"
    pipeline = None

    if pipeline:
        # TODO: Add the three steps to the pipeline:
        # Step 1: 'Data-Preprocess' (no dependencies)
        # Step 2: 'Model-Train'     (depends_on='Data-Preprocess')
        # Step 3: 'Model-Register'  (depends_on='Model-Train')

        # TODO: Call pipeline.execute() to simulate the sequential run
        pass  # Remove this line once you add the TODOs above
