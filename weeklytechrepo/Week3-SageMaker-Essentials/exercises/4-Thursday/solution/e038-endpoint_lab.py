...
def deploy_production_model(iam_role):
    ...
    # 2. Call .deploy() on the model
    predictor = model.deploy(
        initial_instance_count=2,
        instance_type="ml.m5.large",
        endpoint_name="production-endpoint-v1",
