...
def chunk_document(master_text: str, chunk_size: int, chunk_overlap: int) -> list[Document]:
    ...
    # 1. TODO: Split the master_text into a list of words
    words = []
    chunks = []
    
    # 2. TODO: Iterate over the words, extracting chunks of size 'chunk_size'
    # Remember to advance your pointer by (chunk_size - chunk_overlap)
