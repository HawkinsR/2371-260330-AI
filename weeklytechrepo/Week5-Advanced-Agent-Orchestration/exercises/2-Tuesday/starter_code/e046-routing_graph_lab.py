...
# 1. State Definition
# =====================================================================
# 1. TODO: Define the AgentState TypedDict with keys: user_input, loyalty_tier, and final_answer (all strings)
...
def route_by_tier(state: AgentState) -> str:
    ...
    # 2. TODO: Look at state.get("loyalty_tier"). 
...
def build_support_graph():
    ...
    # 3. TODO: Initialize the StateGraph with your AgentState
    builder = None
    
    # 4. TODO: Add the 3 nodes: "analyzer", "priority", and "standard"
    
    
    
    # 5. TODO: Define execution flow. Link START -> "analyzer"
    
    
    # 6. TODO: Add conditional edges from "analyzer" using route_by_tier.
    # Map the output strings "priority" and "standard" to their respective nodes.
    
    
    # 7. TODO: Link the terminal nodes "priority" and "standard" back to END
    
    
    # 8. TODO: Compile and return the graph
    return None
