...
def executive_assistant_node(state: AssistantState, config: dict, store: InMemoryStore):
    ...
    # 1. TODO: Extract the user_id from the graph configuration dictionary
    user_id = ""
    
    namespace = ("executive_profiles", user_id)
    
    # 2. TODO: Look up the user's profile in the global store
    user_profile = None
    
    if user_profile:
        # 3. TODO: Extract their name and style from the profile.value dict.
        ...
        # 4. TODO: First time seeing this user. Store a default profile containing
...
def build_assistant_graph():
    ...
    # 5. TODO: Instantiate BOTH the global Store and the thread Checkpointer
    ...
    # 6. TODO: Compile the graph, attaching the store and checkpointer
    graph = None
    
    return graph, None # Return store for testing purposes
