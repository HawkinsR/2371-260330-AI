...
def generator_node(state: ValidationState):
    ...
    # 1. TODO: If there are NO critiques, output the bad JSON draft (with single quotes).
    ...
    # 2. TODO: Return the updated state. Increment revision_count by 1.
    return {
        "draft": draft,
...
def build_reflection_graph():
    ...
    # 6. TODO: Add the Generator and Evaluator nodes
    
    
    # 7. TODO: Build the execution flow:
    # START -> Generator -> Evaluator
    
    
    # 8. TODO: Add conditional edges from Evaluator using should_continue.
