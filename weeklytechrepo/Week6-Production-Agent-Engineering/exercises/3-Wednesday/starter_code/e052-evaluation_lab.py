...
# 1. TODO: Complete the Golden Dataset by adding a second test case for remote work.
...
def run_evaluation_suite():
    ...
    # 2. TODO: Use python's `patch` context manager to mock '__main__.fetch_employee_benefits'
        ...
        for i, scenario in enumerate(GOLDEN_DATASET):
            ...
            # 3. TODO: Invoke the hr_agent with the scenario's input
            result = None
            
            # 4. TODO: Extract the actual final_answer and the expected_output
            actual = ""
            expected = ""
            
            # 5. TODO: Grade the result using exact_match_evaluator and add it to total_score
            score = 0
