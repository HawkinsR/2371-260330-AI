...
def firewall_node(state: SecurityState):
    ...
    # 1. TODO: Convert state["user_input"] to lowercase
    user_input = ""
    
    danger_phrases = ["ignore all previous", "bypass", "sudo"]
    
    # 2. TODO: If any danger_phrase is in the user_input, return {"is_safe": False}
...
def data_loss_prevention_node(state: SecurityState):
    ...
    # 3. TODO: Use re.search() to check if ssn_pattern is in the response.
...
def build_secure_graph():
    ...
    # 4. TODO: Define the secure execution flow edge logic
